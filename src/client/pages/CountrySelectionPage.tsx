  ...
  return (
    <div className="game-container bg-country-selection bg-pattern-dots">
      <div className="game-content">
        <div className="card-texture-subtle px-4 py-6 rounded-2xl shadow-xl card-hover-float">
          ...
          {/* Country List */}
          <div className="mb-8 max-h-80 overflow-y-auto border-2 border-gray-200 rounded-game-lg">
            {loading && !error ? (
